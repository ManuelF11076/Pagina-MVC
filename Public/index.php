...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">MANUEL ANTONIO FUENTES RAMIREZ</p>
    </div>
</header>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class=" ms-auto">
                ...
                "Hola, soy Manuel Fuentes, tengo 35 años y me desempeño como técnico. 
                A lo largo de mi carrera, he desarrollado una sólida experiencia en la resolución de problemas técnicos y en la implementación de soluciones eficientes. Mi trabajo implica abordar desafíos tecnológicos con confianza y habilidad, siempre buscando las mejores maneras de optimizar los procesos y asegurar que todo funcione correctamente. Me apasiona el mundo de la tecnología y disfruto enfrentándome a nuevos retos que me permiten aprender y crecer en mi campo profesional.".</p>
            </div>
        </div>
